...
<html lang="en">
  ...
  <body>
    ...
    <section id="story" class="story">
      <h2>Story : <span>Ahilla Kammala</span>  </h2>
      <div class="row">
        <div class="story-img">
...
<p>Name : Ahilla Haffat Kammala</p>
 <p>Address : Jombang, East Java</p> 
 <p> Age :<span> <?php echo $umur ?> </span> </p> 
  <p>Motto dalam hidup saya yaitu : <i>(tepo sliro marang wong kang luwih tuo) </i> <span>Supaya saya mendapat Barokah dalam hidup.</span></p>
        </div>
      </div>
    </section>
...
<div class="sec-div" id="contact">
    <div class="container">
        <div class="d-block">
            <div class="box-cont">
                <div class="icon">
                    <a href=<?php echo $youtubeLink ?>><i class="fa fa-youtube-play fa-lg" aria-hidden="true"></i></a>
                </div>
                <h2><a class="link" href=<?php echo $youtubeLink ?>>YouTube</a></h2>
            </div>
            <div class="box-cont">
                <div class="icon">
                    <a href=<?php echo $instagramLink ?>><i class="fa fa-instagram fa-lg" aria-hidden="true"></i></a>
                </div>
                <h2><a class="link" href=<?php echo $instagramLink ?>>Instagram</a></h2>
            </div>
            <div class="box-cont">
                <div class="icon">
                    <a href=mailto:<?php echo $email ?>><i class="fa fa-paper-plane fa-lg" aria-hidden="true"></i></a>
                </div>
                <h2><a class="link" href=mailto:<?php echo $email ?>>Mail</a></h2>
            </div>
        </div>
    </div>
</div>
